...
def upgrade():
    ...
    products_by_category = {
        "Смартфоны": [
            (
                "Apple iPhone 15 Pro",
                "Флагманский смартфон Apple с OLED-дисплеем, процессором A17 и тройной камерой.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung Galaxy S24 Ultra",
                "Смартфон с большим Dynamic AMOLED 2X экраном, поддержкой S Pen и камерой 200 Мп.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Xiaomi 14 Pro",
                "Мощный смартфон с камерой Leica, Snapdragon 8 Gen 3 и быстрой зарядкой.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Google Pixel 8 Pro",
                "Чистый Android, топовая камера и уникальные AI-функции.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "OnePlus 12",
                "Флагман OnePlus с AMOLED-экраном 120 Гц и быстрой зарядкой.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Honor Magic6 Pro",
                "Смартфон с изогнутым дисплеем и камерой 180 Мп.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Nothing Phone (2)",
                "Уникальный дизайн, прозрачная задняя крышка и чистый Android.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Realme GT 5 Pro",
                "Быстрый смартфон с AMOLED-экраном и быстрой зарядкой 150 Вт.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Sony Xperia 1 V",
                "4K OLED-дисплей, профессиональная камера и защита IP68.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Asus Zenfone 10",
                "Компактный флагман с мощным процессором и стереозвуком.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Планшеты": [
            (
                ...
                "Планшет для творчества и работы с поддержкой Apple Pencil 3-го поколения.",
                "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung Galaxy Tab S9 Ultra",
                "AMOLED-планшет с поддержкой S Pen и DeX-режимом.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Xiaomi Pad 6 Pro",
                "Доступный планшет с хорошей батареей и Snapdragon 8+ Gen 1.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Lenovo Tab Extreme",
                "Планшет с клавиатурой, стилусом и 3K-дисплеем.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Huawei MatePad Pro 13.2",
                "Планшет с HarmonyOS, OLED-экраном и поддержкой M-Pencil 3.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Ноутбуки": [
            (
                ...
                "Профессиональный ноутбук на чипе M3 Max, Liquid Retina XDR дисплей.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "ASUS ROG Zephyrus G16",
                "Игровой ноутбук с RTX 4080 и Mini-LED дисплеем.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Dell XPS 13 Plus (2024)",
                "Компактный ультрабук с сенсорной панелью и OLED-экраном.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "HP Spectre x360 14",
                "Трансформер с сенсорным OLED-экраном и стилусом.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Lenovo ThinkPad X1 Carbon Gen 12",
                "Бизнес-ноутбук с легендарной клавиатурой и защитой.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Телевизоры": [
            (
                "LG OLED55C3",
                "4K OLED-телевизор с поддержкой Dolby Vision.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung QN90C Neo QLED",
                "Яркий QLED-телевизор с тонкими рамками.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Sony XR-65A80L",
                "Телевизор с Google TV и отличным звуком.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "TCL 55C845",
                "Доступный QLED-телевизор с HDR.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Philips 50PUS8807",
                "Телевизор с Ambilight и Android TV.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Наушники": [
            ...
            (
                "Apple AirPods Pro 2",
                "TWS-наушники с активным шумоподавлением.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Sennheiser Momentum 4",
                "Аудиофильские наушники с отличным звуком.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "JBL Tune 760NC",
                "Доступные наушники с Bluetooth.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Xiaomi Redmi Buds 4 Pro",
                "Компактные TWS-наушники.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Смарт-часы": [
            (
                ...
                "Смарт-часы с датчиком температуры и ECG.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung Galaxy Watch 6",
                "Часы с AMOLED-экраном и GPS.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Huawei Watch GT 4",
                "Долгая автономность и спортивные функции.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Amazfit GTR 4",
                "Универсальные смарт-часы с GPS.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Garmin Venu 3",
                "Премиальные часы для спорта и здоровья.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Фотоаппараты": [
            (
                "Canon EOS R8",
                "Беззеркальная камера для фото и видео.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Sony Alpha 7 IV",
                "Полнокадровая камера для профессионалов.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Nikon Z6 II",
                "Универсальная камера для путешествий.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Fujifilm X-T5",
                "Камера с ретро-дизайном и отличной цветопередачей.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Panasonic Lumix S5 II",
                "Компактная полнокадровая камера.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Игровые приставки": [
            (
                "Sony PlayStation 5",
                "Консоль нового поколения с SSD.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Microsoft Xbox Series X",
                "Мощная игровая приставка с Game Pass.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Nintendo Switch OLED",
                "Гибридная консоль для дома и поездок.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Valve Steam Deck",
                "Портативная игровая консоль для ПК-игр.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Sony PlayStation 4 Slim",
                "Классика для любителей эксклюзивов.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Мониторы": [
            (
                ...
                "4K игровой монитор с высокой герцовкой.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung Odyssey G7",
                "Изогнутый монитор для геймеров.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Dell UltraSharp U2723QE",
                "Профессиональный монитор с USB-C.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "AOC 24G2U",
                "Доступный монитор с IPS-матрицей.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Philips 346B1C",
                "Широкоформатный монитор для работы и игр.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
        "Аксессуары": [
            (
                ...
                "Премиальная беспроводная мышь.",
                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Razer BlackWidow V4",
                "Механическая клавиатура для геймеров.",
                "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Xiaomi Mi Power Bank 3",
                "Внешний аккумулятор на 20000 мАч.",
                "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Samsung T7 Shield",
                "Портативный SSD для хранения данных.",
                "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80",
            ),
            (
                "Apple AirTag",
                "Bluetooth-метка для поиска вещей.",
                "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80",
            ),
        ],
    }
    ...
    for cat_idx, (cat_name, cat_key) in enumerate(categories):
        cat_id = conn.execute(
            sa.text("SELECT id FROM categories WHERE name=:name"), {"name": cat_name}
        ).scalar()
        ...
        for i in range(1, 101):
            if cat_name == "Смартфоны":
                ...
                specs = {
                    "Экран": random.choice(["6.1", "6.5", "6.7"]) + '" OLED',
                    "Камера": f"{random.randint(12, 200)} Мп",
                    "Батарея": f"{random.randint(3000, 6000)} мАч",
                }
                ...
                specs = {
                    "Экран": random.choice(["10.2", "11", "12.9"]) + '" IPS',
                    "Процессор": random.choice(
                        ["Apple M2", "Snapdragon 8+ Gen 1", "Kirin 9000"]
                    ),
                    "Батарея": f"{random.randint(6000, 12000)} мАч",
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Экран": random.choice(["14", "15.6", "16"]) + '" IPS',
                    "Процессор": random.choice(["Intel i7", "AMD Ryzen 7", "Apple M3"]),
                    "ОЗУ": f"{random.choice([8, 16, 32])} ГБ",
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Разрешение": random.choice(["4K", "8K", "FullHD"]),
                    "Тип": random.choice(["OLED", "QLED", "LED"]),
                    "Год": random.choice([2022, 2023, 2024]),
                }
                image_url = random.choice(image_urls_pool)
                ...
                description = (
                    f"Наушники {brand} {model}, цвет: {color}. Отличный звук и комфорт."
                )
                specs = {
                    "Тип": random.choice(["TWS", "Накладные", "Вкладыши"]),
                    "Шумоподавление": random.choice(["Да", "Нет"]),
                    "Время работы": f"{random.randint(5, 40)} ч",
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Экран": random.choice(["AMOLED", "IPS"]),
                    "GPS": random.choice(["Да", "Нет"]),
                    "Влагозащита": random.choice(["IP68", "5ATM"]),
                }
                image_url = random.choice(image_urls_pool)
                ...
                description = (
                    f"Фотоаппарат {brand} {model} комплект: {ctype}. Для фото и видео."
                )
                specs = {
                    "Матрица": random.choice(["APS-C", "FullFrame", "Micro 4/3"]),
                    "Мп": random.randint(16, 60),
                    "Видео": random.choice(["4K", "8K", "FullHD"]),
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Поколение": random.choice(["9-е", "8-е"]),
                    "Диск": random.choice(["SSD", "HDD"]),
                    "Год": random.choice([2020, 2021, 2022, 2023]),
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Разрешение": random.choice(["4K", "QHD", "FullHD"]),
                    "Тип": random.choice(["IPS", "VA", "OLED"]),
                    "Гц": random.choice([60, 75, 120, 144, 165]),
                }
                image_url = random.choice(image_urls_pool)
                ...
                specs = {
                    "Тип": atype,
                    "Совместимость": random.choice(
                        ["универсальный", "Apple", "Android"]
                    ),
                }
                image_url = random.choice(image_urls_pool)
            else:
                name = f"{cat_name} {i}"
                description = (
                    f"Описание для {name} — современный товар категории {cat_name}."
                )
                specs = {
                    "spec1": f"value{random.randint(1, 10)}",
                    "spec2": f"value{random.randint(1, 10)}",
                }
                image_url = random.choice(image_urls_pool)
